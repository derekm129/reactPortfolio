    ...
    <div className='container text-center'>
      <div className='row justify-content-center align-items-center'>
        ...
        <div className='col-md-6 mt-5'>
          <p className='m-3' style={{ color: 'white', boxShadow: '0px 0px 3px 3px limegreen', fontSize: '1.7em' }}>
          ...
          <div className="buttons mt-3">
            <a href="https://www.linkedin.com/in/derek-modugno-9927b72b1/" className='mb-2 m-2'>
              <button className='btn btn-lg bg-primary'>View Linkedin</button>
            </a>
            <a href="https://github.com/derekm129" className='mb-2 m-2'>
              <button className='btn btn-lg bg-secondary'>View GitHub</button>
            </a>
          </div>
        </div>
        {/* Profile Picture */}
